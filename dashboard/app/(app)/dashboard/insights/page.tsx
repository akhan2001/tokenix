  ...
  return (
    <>
            ...
            body={
              singleDay ? (
                ...
                <>
                  ...
                  Check the <a href="/dashboard/connect" style={{ color: "var(--accent)" }}>Connect</a> page
      ...
      {models.models.length > 0 && (
        <section
          className="app-wrap"
          style={{ maxWidth: 1080, margin: "0 auto", width: "100%", padding: "var(--space-section-sm) var(--pad-x) var(--space-section-md)" }}
        >
