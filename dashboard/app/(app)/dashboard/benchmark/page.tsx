...
export default async function BenchmarkPage() {
  ...
  try {
    ...
    return (
      <>
        ...
        <section style={{ maxWidth: 1080, margin: "0 auto", padding: "var(--space-section-md) var(--pad-x)" }}>
          <EmptyState
  ...
  return (
    <>
      ...
      <section
        className="app-wrap"
        style={{ maxWidth: 1080, margin: "0 auto", width: "100%", padding: "var(--space-section-sm) var(--pad-x) var(--space-section-xs)" }}
      >
      ...
      {data.models.length === 0 ? (
        <section style={{ maxWidth: 1080, margin: "0 auto", padding: "0 var(--pad-x) 64px" }}>
          <EmptyState
        ...
        <>
          ...
          <section
            className="app-wrap"
            style={{ maxWidth: 1080, margin: "0 auto", width: "100%", padding: "0 var(--pad-x) 40px" }}
          >
            <div
          ...
          <section
            className="app-wrap"
            style={{ maxWidth: 1080, margin: "0 auto", width: "100%", padding: "0 var(--pad-x) var(--space-section-sm)" }}
          >
          ...
          {data.opportunities.length > 0 && (
            <section
              className="app-wrap"
              style={{ maxWidth: 1080, margin: "0 auto", width: "100%", padding: "0 var(--pad-x) 64px" }}
            >
