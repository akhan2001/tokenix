 ...
 * `findWorkspace` turns that into the workspace they own. Someone signed in
 * but not yet provisioned goes to /dashboard/connect, which is the sole
 * onboarding surface: it mints the workspace, shows the key once, and walks
 * through provider setup and a live test before sending anyone here.
 *
